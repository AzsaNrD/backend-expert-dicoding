...
describe('JwtTokenManager', () => {
  describe('getTokenFromHeader function', () => {
    it('should throw AuthenticationError when no Authentication header', async () => {
      // Arrange
    ...
    it('should change bearer token to access token', async () => {
      // Arrange
      const tokenFromHeader = 'Bearer token';
      const jwtTokenManager = new JwtTokenManager({});

      // Action
      const token = await jwtTokenManager.getTokenFromHeader(tokenFromHeader);
